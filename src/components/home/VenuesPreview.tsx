    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="body-lg text-slate-600 dark:text-slate-400 max-w-md">
          16 ciudades sede, 3 países, 1 sueño compartido. Explora los estadios que harán historia en 2026.
        </p>
      </div>
      ...
      <div className="space-y-4">
        <div className="flex items-center gap-4 bg-white dark:bg-slate-800 p-4 rounded-2xl shadow-sm">
          ...
          <span className="font-bold uppercase tracking-tight">16 Sedes confirmadas</span>
        </div>
        <div className="flex items-center gap-4 bg-white dark:bg-slate-800 p-4 rounded-2xl shadow-sm">
          <div className="w-10 h-10 bg-fifa-red/10 flex items-center justify-center rounded-full text-fifa-red">
            <Users size={20} />
          </div>
          <span className="font-bold uppercase tracking-tight">Capacidad récord histórica</span>
        </div>
      </div>
    </div>
