      ...
      <div className="container mx-auto space-y-8">
        ...
        <header className="flex flex-col md:flex-row justify-between items-end gap-6 mb-12">
          ...
          <div className="flex gap-4">
            <KPI label="Partidos" value="64" card />
            <KPI label="Goles" value="172" card />
          </div>
        </header>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-8">
            ...
            <div className="stadium-card p-6 border-l-4 border-fifa-gold">
              <h3 className="label-caps mb-4 flex justify-between">
                Malla de Oro <span className="text-fifa-gold">🧤</span>
              </h3>
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 bg-slate-900 rounded-lg overflow-hidden">
                  <img src="https://crests.football-data.org/ARG.svg" className="w-full h-full scale-125" alt="Argentina" />
                </div>
                <div>
          ...
          <div className="lg:col-span-2 stadium-card overflow-hidden">
            <div className="p-8">
              ...
              <div className="relative aspect-[21/9] bg-slate-100 dark:bg-slate-800 rounded-xl overflow-hidden">
                <div className="absolute inset-0 bg-cover opacity-50 grayscale" />
...
const KPI = ({ label, value, card }: KPIProps) => (
  <div className={cn(
