...
export default function WorldMap() {
  ...
  const [activeLayer, setActiveLayer] = useState<'SEDES' | 'RUTAS' | 'CALOR'>('SEDES');
          ...
          {filteredStadiums.map(stadium => (
            ...
            >
              <div className="w-20 h-20 rounded-lg overflow-hidden flex-shrink-0">
                <img src={stadium.imageUrl} className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" />
              </div>
